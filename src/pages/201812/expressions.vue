...
export default {
  ...
  data() {
    return {
      baseUrl: cdnUrl + "/fe/marketing/img/expressions_imitate/",
      style: {
        root: {
...
@imageHost: "http://cdn.xingstation.cn/fe/marketing/img/expressions_imitate/";
html,
body {
  width: 100%;
  height: 100%;
