<template>
  ...
  >
    <img
      :src="baseUrl + 'f1.png'+ this.$qiniuCompress()"
      class="front-1"
    >
    <img
      :src="baseUrl + 'f2.png'+ this.$qiniuCompress()"
      class="front-2"
    >
    <img
      :src="baseUrl + 'post.png'+ this.$qiniuCompress()"
      :class="{'x-post':iphoneX,'post':!iphoneX}"
      class="post"
    >
    <img
      v-if="photo !== null"
...
export default {
  ...
  data() {
    return {
      baseUrl: cdnUrl + "/fe/marketing/img/post_office/",
      style: {
        root: {
...
@imageHost: "http://cdn.xingstation.com/fe/marketing/img/post_office/";
html,
body {
  width: 100%;
  height: 100%;
