...
export default {
  ...
  methods: {
    ...
    drawing() {
      ...
      // let url =
      //   'https://cdn.xingstation.com/fe/marketing/img/open_pig/666.png'
      let imgUrl = 'https://cdn.xingstation.com/fe/marketing/img/open_pig/' + this.fanpaths[this.type]
      let imgUrl2 = 'https://cdn.xingstation.com/fe/marketing/img/open_pig/t.png'
      let imgUrl3 = 'https://cdn.xingstation.com/fe/marketing/img/open_pig/' + this.rnd(1, this.paths.length) + '.png'
      mc.background('https://cdn.xingstation.com/fe/marketing/img/open_pig/bg_two.png', {
        left: '0%',
        top: '0%',
        type: 'origin',
...
@imageHost: "http://cdn.xingstation.com/fe/marketing/img/open_pig/";
/*声明 WebFont*/
@font-face {
  font-family: "MatrixCode";
  src: url("http://cdn.xingstation.com/fe/marketing/img/open_pig/jinhei.TTF");
  font-weight: normal;
  font-style: normal;
}
html,
