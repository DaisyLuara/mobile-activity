...
export default {
  ...
  data() {
    return {
      ...
      hasUsed: false,
      img: null,
      // img: 'https://cdn.xingstation.com/fe/image/drc_year19_dfth/card_1_b.png',
      userId: null,
      id: this.$route.query.id,
      qrcodeImg: null,
      // qrcodeImg: 'https://cdn.xingstation.com/fe/image/couponrain/5c22f3d46c008.png',
      wxShareInfoValue: {
        title: "来东方童画激发潜能",
        desc: "点击领取",
...
@imageHost: "http://cdn.xingstation.com/fe/marketing/img/orientalMyth/";
html,
body {
  width: 100%;
  height: 100%;
