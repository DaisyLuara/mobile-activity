<template>
  ...
  >
    <div class="contain">
      ...
      >
      <img
        :src="baseUrl + 'cloud03.png'+ this.$qiniuCompress()"
        class="cloudThree"
      >
      <img
        v-if="photo !== null"
...
export default {
  ...
  data() {
    return {
      baseUrl: cdnUrl + "/fe/marketing/img/pig_smoothly/",
      style: {
        root: {
...
@imageHost: "http://cdn.xingstation.com/fe/marketing/img/pig_smoothly/";
html,
body {
  width: 100%;
  height: 100%;
