...
export default {
  ...
  data() {
    return {
      ...
      userId: null,
      coupon_img: null,//'https://cdn.xingstation.com/fe/image/zhufu/test.png',
      ...
      wxShareInfoValue: {
        ...
        imgUrl: "https://cdn.xingstation.com/fe/image/zhufu/icon.jpg"
      }
    }
  },
  watch: {
...
@img: "http://cdn.xingstation.com/fe/image/zhufu/";
html,
body {
  width: 100%;
  height: 100%;
