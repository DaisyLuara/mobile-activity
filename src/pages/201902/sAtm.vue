...
export default {
  ...
  data() {
    return {
      ...
      coupon_img: null,//'https://cdn.xingstation.cn/fe/image/qpyl/2_2.png',
      qrcodeImg: null,//'http://papi.xingstation.com/qrcode/5c7de9583796b.png',
      barcode_url: null,//'https://cdn.xingstation.cn/fe/image/sAtm/tiao.png'
      used: false,//false,
      passed: false,//false
      ...
      wxShareInfoValue: {
        title: "笑容ATM",
        desc: "笑容ATM",
        imgUrl: "https://cdn.xingstation.cn/fe/image/sAtm/icon.jpg"
      }
    }
  },
  watch: {
...
@img: "http://cdn.xingstation.cn/fe/image/sAtm/";
html,
body {
  width: 100%;
  height: 100%;
