...
export default {
  ...
  data() {
    return {
      ...
      bgcover: false,
      loading: true,
      coupon_img: null,//'https://cdn.xingstation.com/fe/image/jinzhan/test.png',
      ...
      wxShareInfoValue: {
        title: "金展",
        desc: "金展",
        imgUrl: "https://cdn.xingstation.com/fe/image/jinzhan/icon.jpg"
      }
    }
  },
  watch: {
  ...
  methods: {
    ...
    handlePost() {
      let url =
        'oid=' + this.oid + '&belong=' + this.belong + '&name=&img=' + this.head_img_url + ',' + this.nick_name + ',' + this.name + '&id=' + this.id + '&api=json'
...
@img: "http://cdn.xingstation.com/fe/image/jinzhan/";
html,
body {
  width: 100%;
  height: 100%;
