  ...
  data() {
    return {
      ...
      wxShareInfoValue: {
        ...
        imgUrl:
          'http://h5-images.oss-cn-shanghai.aliyuncs.com/xingshidu_h5/marketing/wx_share_icon/dance_share_icon.jpg'
      },
      //控制swiper的效果
      swiperOption: {
        effect: 'cube',
          ...
          slideChangeTransitionEnd: function() {
            ...
            if (this.swiper.activeIndex >= this.pageSize) {
              if (this.swiper.activeIndex == 3) {
                ...
                this.pageSize++
                if (
                  this.imgDate[this.pageSize].imgaUrl == '' ||
                  this.imgDate[this.pageSize].imgaUrl == null ||
                  this.imgDate[this.pageSize].imgaUrl == undefined
                ) {
                  this.pageSize++
                  //表示切换到最后一个不显示小偶
                }
            ...
            switch (this.swiper.activeIndex) {
              case 0:
                break
              case 1:
                this.showStar.showStarOne = true
                break
              case 2:
                this.showStar.showStarTwo = true
                break
              default:
                this.showStar.showStarThree = true
                break
            }
  ...
  methods: {
    gitGo() {
      for (var i = 0; i < this.imgDate.length; i++) {
        if (
          this.imgDate[i].imgaUrl != '' &&
          this.imgDate[i].imgaUrl != null &&
          this.imgDate[i].imgaUrl != undefined
        ) {
          this.pageSize = i
          break
        }
