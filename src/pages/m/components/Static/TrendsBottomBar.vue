...
export default {
  ...
  data() {
    return {
      deleteUrl: "http://cdn.xingstation.com/fe/image/m/m-menu-delete.svg",
      saveUrl: "http://cdn.xingstation.com/fe/image/m/m-menu-download.svg",
      shareUrl: "http://cdn.xingstation.com/fe/image/m/m-menu-share.svg",
