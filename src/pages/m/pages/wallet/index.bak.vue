<template>
  <div class="wallet">
    <img
      class="bg"
      src="https://cdn.xingstation.com/fe/image/m/wallet-no-bg.jpeg"
    >

    <img
      v-if="loginState.gender === '1'"
      class="xo"
      src="https://cdn.xingstation.com/fe/image/m/wallet-no-xo.png"
    >
    <img
      v-else
      class="xo"
      src="https://cdn.xingstation.com/fe/image/m/wallet-no-xo-boy.png"
    >
