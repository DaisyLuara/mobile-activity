  ...
  methods: {
    ...
    initAnimation() {
      ...
      lottie.loadAnimation({
        ...
        loop: true,
        autoplay: true,
        assetsPath: 'http://cdn.xingstation.cn/fe/marketing/christmas/img/',
        path: 'http://cdn.xingstation.cn/fe/marketing/christmas/json/h5xuehua.json' // the path to the animation json
      })
    },
    //图片预加载处理
    loadImage() {
...
@imageHost: 'http://cdn.xingstation.cn/fe/marketing/img/mc_Christmas';
.root {
  width: 100%;
