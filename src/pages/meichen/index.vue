      ...
      <div class="swiper-wrapper">
        ...
        <div class="swiper-slide">
          <div class="slide-page5">
            ...
            <!-- <img
              class="qr-code" 
              src="http://cdn.xingstation.com/fe/marketing/meichen/page5-qr.png" /> -->
            <img
...
const serverUrl = 'http://cdn.xingstation.com/fe/marketing/meichen/'
export default {
  data() {
    return {
      serverUrl: serverUrl,
    ...
    .swiper-slide {
      ...
      .slide-page1 {
        ...
        .page1-title {
          ...
          background-image: url('http://cdn.xingstation.com/fe/marketing/meichen/page1-2.png?imageView2/0/q/30');
        }
        .page1-footer {
          width: 100%;
        }
