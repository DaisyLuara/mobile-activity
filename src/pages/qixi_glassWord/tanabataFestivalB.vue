  ...
  data() {
    return {
      ...
      wxShareInfo: {
        title: '七夕，我们谈个恋爱吧！',
        desc: '用一生说我爱你',
        link: 'http://papi.xingstation.com/api/s/wpR' + window.location.search,
        imgUrl: cdnUrl + '/fe/marketing/img/tanabataFestival/share2.png',
        success: () => {
          wechatShareTrack()
        }
      }
...
@imageHost: 'http://cdn.xingstation.com/fe/marketing/img/tanabataFestival';
.root {
  width: 100%;
  background: #ec7ca9;
  position: relative;
