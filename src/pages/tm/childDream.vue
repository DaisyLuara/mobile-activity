<template>
  ...
  >
    ...
    <div class="block coupons">
      <img :src="base + 'childDream1.png' + this.$qiniuCompress()">
    </div>
  </div>
</template>
<script>
  ...
  data() {
    return {
      ...
      wxShareInfoValue: {
        ...
        link: process.env.AD_API+'/api/s/mw0' + window.location.search,
        imgUrl:
          'http://cdn.xingstation.cn/image/tm/guoqing/share_childDream.png',
        success: function () {
          wechatShareTrack()
        }
      }
