  ...
  methods: {
    ...
    initAnimation() {
      ...
      lottie.loadAnimation({
        ...
        loop: true,
        autoplay: true,
        assetsPath: 'http://cdn.xingstation.com/fe/marketing/img/wc/lottie/',
        path: 'http://cdn.xingstation.com/fe/marketing/img/wc/lottie/h5-2.json' // the path to the animation json
      })
    },
    fetchNumberData() {
    ...
    handleEvent(e) {
      if (
        ...
        'http://cdn.xingstation.com/fe/marketing/img/wc/lottie/img_0.png'
      ) {
        this.$router.push({
