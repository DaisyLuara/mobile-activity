...
@font-face {
  font-family: "huakang";
  src: url("http://cdn.xingstation.cn/image/zhongqiu/font/huakang.ttf");
  src: url("http://cdn.xingstation.cn/image/zhongqiu/font/huakang.eot"),
    url("http://cdn.xingstation.cn/image/zhongqiu/font/huakang.woff"),
    url("http://cdn.xingstation.cn/image/zhongqiu/font/huakang.ttf"),
    url("http://cdn.xingstation.cn/image/zhongqiu/font/huakang.svg");
  font-weight: normal;
  font-style: normal;
}
